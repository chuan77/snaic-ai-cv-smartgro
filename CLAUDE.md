...
- `src/deploy/` — `register.py` (`AutonomousPOSRegister`, used live by `main_day5_deploy.py`), `web_dashboard.py` (`SmartCartPresentationApp`, unimplemented stub), plus the FastAPI/Label Studio/active-learning surface described in `docs/handoff-2026-07-08.md` (not yet folded into this section).
