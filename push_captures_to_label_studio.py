...
from src.deploy.label_studio_push import get_ls_project_id, get_push_min_detections, push_staging_dir
...
if __name__ == "__main__":
    ...
    pushed = push_staging_dir(get_capture_dir(), project_id, min_detections=get_push_min_detections())
