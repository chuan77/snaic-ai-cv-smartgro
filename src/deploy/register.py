"""Day 5: Gradio checkout dashboard wiring detection results to priced receipts. Used by main_day5_deploy.py."""
import logging
...
class AutonomousPOSRegister:
    ...
    def compile_transaction_bill(self, frame_rgb: np.ndarray) -> tuple:
        ...
        # Convert back to internal BGR structure for correct YOLO processing
        ...
        # Format the visual tracking display matrix
        ...
        # Aggregate scan groups using standard pandas metrics
        ...
        # Compile customer-facing Markdown receipt
